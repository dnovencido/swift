<?php
/**
 * Test server endpoint with correct device_id format
 */

// Simulate Arduino data transmission with device_id
$testData = [
    'device_id' => 'D001',  // This was the missing field
    'timestamp' => '14/10/2025 11:30:00 PM',
    'temp' => 25.5,
    'hum' => 70.0,
    'ammonia' => 15.0,
    'thermal' => 26.0,
...
echo "Testing server endpoint with device_id...\n";
echo "Simulating data from Arduino (192.168.1.11) with device_id: D001\n\n";
